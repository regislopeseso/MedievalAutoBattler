...
{
    public class BattleResultsCreateResponse
    {
        public List<BattleResultsCreateResponse_Card> NpcCards { get; set; }
        public List<BattleResultsCreateResponse_Card> PlayerCards { get; set; }
